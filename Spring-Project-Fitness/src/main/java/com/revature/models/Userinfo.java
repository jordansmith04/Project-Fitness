...
public class Userinfo {
	...
	@GeneratedValue(generator = "polkaman_id_seq", strategy = GenerationType.AUTO) //specifies that this ID is auto generated by some sort of sequence
	@SequenceGenerator(name="polkaman_id_seq", allocationSize = 1) //Generates the sequence you want to use
	@Column
	String username;
