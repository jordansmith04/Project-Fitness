...
public class Futureworkouts {
	...
	@Id
	@GeneratedValue(generator = "futureworkouts_id_seq", strategy = GenerationType.AUTO) //specifies that this ID is auto generated by some sort of sequence
	@SequenceGenerator(name="futureworkouts_id_seq", allocationSize = 1) //Generates the sequence you want to use
	@Column
	int workoutnumber;
